  ...
  return (
    <section id="newsletter" className="py-20 bg-gradient-to-br from-primary via-primary-dark to-primary relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 right-[5%] text-white/5 text-6xl rotate-45">🐾</div>
      </div>
        ...
        <AnimatePresence mode="wait">
          {submitted ? (
            ...
            >
              ...
              <h2 className="text-3xl font-bold text-white mb-4">Perfetto, ci sei!</h2>
            ...
            <motion.div key="form" className="text-center">
              <AnimatedSection>
                ...
                <p className="text-base sm:text-lg text-white/80 max-w-lg mx-auto">
                  ...
                  professionisti pet <strong className="text-white">vicino a te</strong>. Gratis, per sempre.
                </p>
              </AnimatedSection>

              <AnimatedSection delay={0.3}>
                {/* Card form con sfondo bianco semi-trasparente */}
                <div className="mt-10 bg-white/10 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-white/15">
                  ...
                  {error && (
                    <motion.p
                      className="mt-3 text-red-200 text-sm text-center"
